  ...
  return (
    <Container>
      ...
      >
        ...
        <MDBox pl={{ xs: 0, lg: 6 }} color="inherit" display={{ xs: "none", lg: "flex" }} m={0} p={0}>
          <DefaultNavbarLink icon={
            <AccountCircleIcon sx={{
              color: ({ palette: { white, secondary } }) => (light ? white.main : secondary.main),
              verticalAlign: "middle",
            }} />
          } name="Log In" route="/login" light={light} />
          <DefaultNavbarLink icon={
            <KeyIcon sx={{
              color: ({ palette: { white, secondary } }) => (light ? white.main : secondary.main),
              verticalAlign: "middle",
            }} />
          } name="Register" route="/register" light={light} />
        </MDBox>
        {action &&
