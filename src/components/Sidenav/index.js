    ...
    if (type === "collapse") {
      returnValue = href ? (
        ...
        <NavLink
          key={key}
          to={route
            .replace(":projectName", decodeURIComponent(localStorage.getItem("projectName")))
            .replace(":taskId", decodeURIComponent(localStorage.getItem("taskId")))}
        >
          <SidenavCollapse
            name={name}
            icon={icon}
            active={
              key
                .replace(":projectName", decodeURIComponent(localStorage.getItem("projectName")))
                .replace(":taskId", decodeURIComponent(localStorage.getItem("taskId"))) ===
              decodeURIComponent(collapseName)
            }
          />
        </NavLink>
      );
