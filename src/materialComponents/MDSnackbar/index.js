...
import MDSnackbarIconRoot from "materialComponents/MDSnackbar/MDSnackbarIconRoot";
...
function MDSnackbar({ color, icon, title, dateTime, content, route, close, bgWhite, ...rest }) {
    ...
    >
      ...
      >
        <MDBox
          ...
          p={1.5}
        >
          <MDBox component={Link} route={route} display="flex" alignItems="center" lineHeight={0}>
